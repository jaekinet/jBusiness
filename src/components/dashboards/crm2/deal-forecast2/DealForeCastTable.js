      ...
      <Table className="fs-10 mb-0">
        <thead className="bg-200">
          <tr>
            ...
            <th className="text-800 text-nowrap text-center">Title</th>
            <th className="text-800 text-nowrap text-center">Post</th>
            <th className="text-800 text-nowrap text-center">Posta</th>
            <th className="text-800 text-nowrap text-end">Postb</th>
          </tr>
        </thead>
        <tbody>
          {data.map((item, index) => (
